package com.tenzliu.tenzbottomlayoutbar.newviewcenter;
...
public class NewViewCenterActivity extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newview_center);
        initView();
        initData();
    }
